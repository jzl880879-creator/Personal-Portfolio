...
createRoot(document.getElementById('root')).render(window.location.pathname.startsWith('/projects') ? <ProjectOverviewPage/> : window.location.pathname.startsWith('/resume') ? <ResumePage/> : window.location.pathname.startsWith('/ai-expression') ? <AIExpressionPage/> : window.location.pathname.startsWith('/industrial-design') ? <IndustrialDesignPage/> : window.location.pathname.startsWith('/product-definition') ? <ProductDefinitionPage/> : window.location.pathname.startsWith('/product-management') ? <ProductManagement/> : window.location.pathname.startsWith('/decisions') ? <DecisionPage/> : window.location.pathname.startsWith('/validation') ? <ValidationPage/> : window.location.pathname.startsWith('/delivery') ? <DeliveryPage/> : window.location.pathname.startsWith('/insights') ? <InsightsPage/> : window.location.pathname.startsWith('/medical/') ? <LaserProject/> : window.location.pathname.startsWith('/medical') ? <MedicalProject/> : window.location.pathname.startsWith('/industrial') ? <IndustrialProject/> : <App/>)
